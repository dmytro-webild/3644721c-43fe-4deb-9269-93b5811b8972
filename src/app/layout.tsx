...
export const metadata: Metadata = {
  title: "Nexonix | Servicios Informáticos Premium en Valdemoro",  description: "Montaje de ordenadores personalizados, mantenimiento preventivo y soporte técnico profesional para PYMES, autónomos y particulares. Calidad, transparencia y rendimiento garantizado.",  keywords: "servicios informáticos Valdemoro, montaje ordenadores, mantenimiento PC, soporte técnico, PYMES Madrid",  metadataBase: new URL("https://nexonix.es"),
  alternates: {
    canonical: "https://nexonix.es"},
  openGraph: {
    title: "Nexonix | Servicios Informáticos Premium",    description: "Tu equipo, siempre al máximo nivel. Servicios informáticos profesionales en Valdemoro.",    url: "https://nexonix.es",    siteName: "Nexonix",    type: "website",    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3Aidc3onj0Uywj4IpRkqF30QNvD/a-professional-computer-hardware-assembl-1773079708512-b0f9d20e.png",        alt: "Servicios Informáticos Nexonix"},
    ],
  },
  twitter: {
    card: "summary_large_image",    title: "Nexonix | Servicios Informáticos Premium",    description: "Montaje, mantenimiento y soporte técnico profesional para tu negocio.",    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3Aidc3onj0Uywj4IpRkqF30QNvD/a-professional-computer-hardware-assembl-1773079708512-b0f9d20e.png"],
  },
  robots: {
    index: true,
    follow: true,
